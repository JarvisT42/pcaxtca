  <aside class="sidenav navbar navbar-vertical navbar-expand-xs  fixed-start  bg-gray-400" id="sidenav-main">
      ...
      <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
          <ul class="navbar-nav">
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#productManagementDropdown" role="button" aria-expanded="false" aria-controls="productManagementDropdown">
                  ...
                  <div class="collapse" id="productManagementDropdown">
                      <ul class="nav flex-column ms-4">
                          <li class="nav-item">
                              <a class="nav-link" href="add_product">Add Product</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="manage_product">Manage Products</a>
                          </li>
                      </ul>
                  </div>
              </li>
              ...
              <li class="nav-item">
                  <a class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#inventoryManagementDropdown" role="button" aria-expanded="false" aria-controls="inventoryManagementDropdown">
                      <div class="d-flex align-items-center">
                          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                              <!-- SVG icon here -->
                              <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                  ...
                  <div class="collapse" id="inventoryManagementDropdown">
                      <ul class="nav flex-column ms-4">
                          <li class="nav-item">
                              <a class="nav-link" href="sample-table1.php">Restock Inventory</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="sample-table2.php">Low Stock Alerts</a>
                          </li>
                          <li class="nav-item">
                              <a class="nav-link" href="sample-table2.php">Inventory Logs (optional)</a>
                          </li>
                      </ul>
                  </div>
              </li>
