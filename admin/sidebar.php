         ...
         <ul class="navbar-nav">
             ...
             <li class="nav-item">
                 <a class="nav-link d-flex justify-content-between align-items-center "
                     ...
                     href="#productManagementDropdown"
                     role="button"
                     aria-expanded="<?= $isProductDropdownActive ? 'true' : 'false' ?>"
                 ...
                 <div class="collapse <?= $isProductDropdownActive ? 'show' : '' ?>" id="productManagementDropdown">
                     <ul class="nav flex-column ms-4">
                         <li class="nav-item">
                             <a class="nav-link <?= $currentPage == 'add_product.php' ? 'active' : '' ?>" href="add_product.php">Add Product</a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link <?= $currentPage == 'manage_product.php' ? 'active' : '' ?>" href="manage_product.php">Manage Products</a>
                         </li>
                         <li class="nav-item">
             ...
             <li class="nav-item">
                 <a class="nav-link d-flex justify-content-between align-items-center "
                     data-bs-toggle="collapse"
                     href="#inventoryManagementDropdown"
                     role="button"
                     aria-expanded="<?= $isInventoryDropdownActive ? 'true' : 'false' ?>"
                 ...
                 <div class="collapse <?= $isInventoryDropdownActive ? 'show' : '' ?>" id="inventoryManagementDropdown">
                     <ul class="nav flex-column ms-4">
                         <li class="nav-item">
                             <a class="nav-link <?= $currentPage == 'restock_inventory.php' ? 'active' : '' ?>" href="restock_inventory.php">Restock Inventory</a>
                         </li>
                         <li class="nav-item">
                             <a class="nav-link <?= $currentPage == 'sample-table2.php' ? 'active' : '' ?>" href="sample-table2.php">Low Stock Alerts</a>
                         </li>
                     </ul>
                 </div>
             </li>
             ...
             <li class="nav-item">
                 ...
                 <div class="collapse" id="optionalFeaturesDropdown">
                     <ul class="nav flex-column ms-4">
                         ...
                         <li class="nav-item">
                             <a class="nav-link" href="sample-table2.php">Payment Integration</a>
                         </li>
                         <li class="nav-item">
             ...
             <div class="card-body text-start p-3 w-100">
                 ...
                 <div class="docs-info">
                     ...
                     <a
                         href="asd"
                         target="_blank"
                         class="btn btn-white btn-sm w-100 mb-0">Settings</a>
                 </div>
             </div>
         </div>
         <a
