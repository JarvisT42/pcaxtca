<aside class="sidenav navbar navbar-vertical navbar-expand-xs   fixed-start  bg-gray-400" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#tablesDropdown" role="button" aria-expanded="false" aria-controls="tablesDropdown">
                ...
                <div class="collapse" id="tablesDropdown">
                    <ul class="nav flex-column ms-4">
                        <li class="nav-item">
                            <a class="nav-link" href="sample-table1.php">Sample Table1</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="sample-table2.php">Sample Table2</a>
                        </li>
                    </ul>
                </div>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link  " href="virtual-reality.php">
                    ...
                    <span class="nav-link-text ms-1">Virtual Realisty</span>
                </a>
            </li>
